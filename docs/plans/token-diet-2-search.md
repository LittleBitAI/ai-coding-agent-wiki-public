...
상위 12장(`inject.SUGGEST_ASK`)으로 다시 잰 값이다 — 처음엔 60장을 봐서 훅이 못 보는 페이지까지 셌다. 결론은 같다.

| 질의 | 점수 | k | 60% 를 넘는 문턱 | 가장 높은 정밀도 |
| --- | --- | ---: | --- | --- |
| 원문 + 영어본 | cos | 1 | 없음 | 6% (제안 48) |
| 원문 + 영어본 | cos | 2 | 없음 | 6% (제안 62) |
| 원문 + 영어본 | rrf | 1 | 없음 | 7% (제안 99) |
| 원문 + 영어본 | rrf | 2 | 없음 | 6% (제안 133) |
