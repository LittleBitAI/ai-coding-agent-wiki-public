...
| # | 이름 | 무엇 | 상태 |
| --- | --- | --- | --- |
| 1 | hooks | 훅 묶음 주석 영어화 | 미착수 |
| 2 | checks | 검사 묶음 주석 영어화 | 미착수 |
| 3 | analysis | 분석 묶음 주석 영어화 | 미착수 |
| 4 | chat-tools | 채팅 묶음 주석 영어화 | 미착수 |
| 5 | tests | 테스트 주석·함수명 영어화, 회귀 원인 보존 | 미착수 |
| 6 | input | 기존 번역 API 재사용·웹 양 호스트의 inject 입력 번역 실측 | 미착수 |
| 7 | web | 대화·인계 토글/오버레이·답변 및 채널별 출력 지시 전환 | 미착수 |
| 8 | gate | `pytest tool/` + `lint --check` + 웹 빌드 | 미착수 |
